...
export default function OnyxWash({ isDark }: OnyxWashProps) {
  ...
  if (!isDark) {
    return (
      <div style={{ position: 'absolute', inset: 0, overflow: 'hidden', background: 'var(--onyx-bg)', pointerEvents: 'none' }}>
        ...
        <div style={{ position: 'absolute', left: '20%', bottom: '-30%', width: '70%', height: '90%', background: `radial-gradient(50% 50% at 50% 50%, ${a(0.10)}, transparent 65%)`, filter: 'blur(120px)' }} />
  ...
  return (
    <div style={{ position: 'absolute', inset: 0, overflow: 'hidden', background: 'var(--onyx-bg)', pointerEvents: 'none' }}>
      ...
      <div style={{ position: 'absolute', left: '20%', bottom: '-30%', width: '70%', height: '90%', background: `radial-gradient(50% 50% at 50% 50%, ${a(0.12)}, transparent 65%)`, filter: 'blur(120px)' }} />
